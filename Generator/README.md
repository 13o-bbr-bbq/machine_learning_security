# PyGenerator
**Fully automatic generate numerous injection codes using Genetic Algorithm and GAN (Generative Adversarial Networks).**

---
PyGenerator can fully automatic generate numerous injection codes for web app vulnerabilities.  
...
#### Step.0 Generation of injection codes using GA.
...
#### Step.1 Augment injection codes using GAN.
