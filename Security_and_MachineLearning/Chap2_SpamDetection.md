...
ナイーブベイズは、**ベイズの定理**を使用して**分類問題**を解く機械学習アルゴリズムであり、**文書分類**等で利用されています。**実装が容易**かつ**処理速度**が速いとう特徴を活かして、ブログやニュース記事の自動ジャンル分けや、[Webページの種別判定](https://www.mbsd.jp/blog/20160113.html)等のタスクで利用されています。  
