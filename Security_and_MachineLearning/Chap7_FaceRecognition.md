 ...
 * ソフトマックス関数（softmax function）  
 ...
 以下のように、入力値（Input）に対する出力値（Output）の合計を1にします。  
 
 ```
  Node no | Input | Output
 -------------------------------------------
   0      |   5   |  0.6364086465588309
   1      |   2   |  0.031684920796124276
   2      |   3   |  0.08612854443626872
   3      |   4   |  0.23412165725273665
   4      |   1   |  0.011656230956039607
 -------------------------------------------
 ```
